    ...
    <main id="about">
      ...
      <section>
        <p>
          ...
          websites and bots. I also like doing{" "}
      ...
      <section>
        ...
        <p>
          I started in January 2020 to make a website for something in real
          life. I started with Javascript. Back then I thought "true programers"
          used binary and every lanuge can do everything the same. So I learned
          up to conditinals or so and gave up since lock down happend.
        </p>

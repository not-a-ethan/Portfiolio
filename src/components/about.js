...
function About() {
  ...
  return (
    <main id="about">
      <h1>About Me </h1>
        <section>
          <p>Hey, I'm Ethan! I'm a student that loves programming. I like making websites, bots. I also like doing <a href="https://replit.com/bounties">Replit Bounties</a> to get some cycles. I'm an admin on <a href="https://ask.replit.com">Replit Ask</a> and a moderator on <a href="https://replit.com">Replit</a>. I'm currently in the East Coast of the United States.</p>
        </section>
        ...
        <section>
          <h2>My Programming Journey ➡️</h2>
            <p>I started in January 2020 to make a website. I started with Javascript. Back then I thought "true programers" used binary and every lanuge can do everything the same. So I learned up to conditinals or so and gave up since lock down happend.</p>
            ...
            <section className="about-projectLeft about-hiddenRight about-skill">
              <div className="about-imgAndText">
                ...
                <div>
                  ...
                  <p>Javascript can be used for almsot anything. It is used to make HTML interactive, the backend of a website or just about anything.</p>
                </div>
              </div>
            </section>
          ...
          <section className="about-projectLeft about-hiddenRight about-skill">
            <div className="about-imgAndText">
              ...
              <div>
                ...
                <p><abbr title="Sequel or Structured Query Language">SQL</abbr> is used to interact with databses from reading to dbs to writing to them.</p>
              </div>
            </div>
          </section>
          ...
          <section className="about-projectRight about-hiddenLeft about-skill">
            <div className="about-imgAndText">
              ...
              <div>
                ...
                <p>React is a Front end web framework and could be used full stack with another frame woork like Next.js or Remix.</p>
              </div>
            </div>
          </section>
          ...
          <section className="about-projectLeft about-hiddenRight about-skill">
            <div className="about-imgAndText">
              ...
              <div>
                ...
                <p>Github is version control in the web that uses Git. It is also used to host code and open sourse projects.</p>
              </div>
            </div>
          </section>
        </section>

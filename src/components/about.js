...
function About() {
  ...
  cycles.I'm an admin on{" "} <a href = "https://ask.replit.com">Replit Ask <
      /a> and a moderator on{" "}
          <a href="https:/ /
          replit.com ">Replit</a>. I'm currently in the East
      ...
      <section>
        ...
        <p>
          ...
          <span className="italics">tried</span>learning
                  React.Around a year
      ...
      <hr />
        ...
        <section className="about-projectLeft about-hiddenRight about-skill">
          ...
          them.</p>
              ...
              <div className = "about-imgAndText">< img

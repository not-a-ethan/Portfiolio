      ...
      <main>
        <ul>
          <li className="contact-li">
            <img src="./images/discordLogo.svg" alt="Discord logo" className="contact-image" />
            Discord: <code className="contact-code">not_ethan.</code>
          </li>
          <li className="contact-li">
            <img src="./images/githubLogo.png" alt="Github Logo" className="contact-image" />
            <a href="https://github.com/not-a-ethan">Github Profile</a>
          </li>
          <li className="contact-li">
            <img src="./images/replitLogo.png" alt="Replit Logo" className="contact-image" />
            <a href="https://ask.replit.com/u/not-ethan/summary">Replit Ask Profile</a>
          </li>

    ...
    <nav className="nav" id="nav">
      <div style={{gridColumn: "1", width: "fit-content", height: "fit-content"}}>
        ...
        <div style={{alignItems: "left", textAlign: "left"}}>
          <a href="https://github.com/not-a-ethan"><picture alt="Github Logo" className="nav-logo nav-github"><source srcset="./images/githubLogoDark.png" media="(prefers-color-scheme: light)" alt="Github Logo"><img src="./images/githubLogo.png" alt="Github Logo"/></picture></a>

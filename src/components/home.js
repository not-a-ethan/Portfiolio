...
function Home() {
  ...
  return (
    <main id="home" className="main">
      ...
      <hr className="hidden hidden-left" />

      <h2 className="secondary-text hidden hidden-right">My Programming Journey</h2>
      ...
      <p className="hidden hidden-right">
        Then in 2021 I started again learned <span className="secondary-text">HTML, CSS</span> and <span className="secondary-text">JS</span> (JS not for webdev). So I made some websites and then learned JS for <span className="secondary-text">frontend webdev</span>. 
      </p>

      <p className="hidden hidden-left">
        Then learned about front end frame works and tried learning <span className="secondary-text">React</span> but gave up after I finished the basics. Around a year later I re-learned the basics and <span className="secondary-text">taught myself</span> the rest of the framework.
      </p>
